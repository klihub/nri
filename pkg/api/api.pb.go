...
const (
	...
	Capability_INPUT_LINUX_PID_LIMIT          Capability = 3
	Capability_ADJUST_LINUX_OOM_SCORE         Capability = 4
	Capability_INPUT_LINUX_OOM_SCORE          Capability = 5
	Capability_INPUT_IP_ADDRESSES             Capability = 6
	Capability_ADJUST_CDI_DEVICES             Capability = 7
	Capability_INPUT_CDI_DEVICES              Capability = 8
	Capability_ADJUST_LINUX_SECURITY_PROFILE  Capability = 9
	Capability_INPUT_LINUX_SECURITY_PROFILE   Capability = 10
	Capability_ADJUST_LINUX_SECCOMP_POLICY    Capability = 11
	Capability_INPUT_LINUX_SECCOMP_POLICY     Capability = 12
	Capability_ADJUST_LINUX_IO_PRIORITY       Capability = 13
	Capability_INPUT_LINUX_IO_PRIORITY        Capability = 14
	...
	Capability_ADJUST_LINUX_SYSCTL            Capability = 20
	Capability_INPUT_LINUX_SYSCTL             Capability = 21
	Capability_EXTRA_CONTAINER_STATUS         Capability = 22
	Capability_INPUT_UID_AND_GIDS             Capability = 23
	Capability_MAX_CAPABILITY                 Capability = 24
)
...
var (
	Capability_name = map[int32]string{
		...
		3:  "INPUT_LINUX_PID_LIMIT",
		4:  "ADJUST_LINUX_OOM_SCORE",
		5:  "INPUT_LINUX_OOM_SCORE",
		6:  "INPUT_IP_ADDRESSES",
		7:  "ADJUST_CDI_DEVICES",
		8:  "INPUT_CDI_DEVICES",
		9:  "ADJUST_LINUX_SECURITY_PROFILE",
		10: "INPUT_LINUX_SECURITY_PROFILE",
		11: "ADJUST_LINUX_SECCOMP_POLICY",
		12: "INPUT_LINUX_SECCOMP_POLICY",
		13: "ADJUST_LINUX_IO_PRIORITY",
		14: "INPUT_LINUX_IO_PRIORITY",
		...
		20: "ADJUST_LINUX_SYSCTL",
		21: "INPUT_LINUX_SYSCTL",
		22: "EXTRA_CONTAINER_STATUS",
		23: "INPUT_UID_AND_GIDS",
		24: "MAX_CAPABILITY",
	}
	Capability_value = map[string]int32{
		...
		"INPUT_LINUX_PID_LIMIT":          3,
		"ADJUST_LINUX_OOM_SCORE":         4,
		"INPUT_LINUX_OOM_SCORE":          5,
		"INPUT_IP_ADDRESSES":             6,
		"ADJUST_CDI_DEVICES":             7,
		"INPUT_CDI_DEVICES":              8,
		"ADJUST_LINUX_SECURITY_PROFILE":  9,
		"INPUT_LINUX_SECURITY_PROFILE":   10,
		"ADJUST_LINUX_SECCOMP_POLICY":    11,
		"INPUT_LINUX_SECCOMP_POLICY":     12,
		"ADJUST_LINUX_IO_PRIORITY":       13,
		"INPUT_LINUX_IO_PRIORITY":        14,
		...
		"ADJUST_LINUX_SYSCTL":            20,
		"INPUT_LINUX_SYSCTL":             21,
		"EXTRA_CONTAINER_STATUS":         22,
		"INPUT_UID_AND_GIDS":             23,
		"MAX_CAPABILITY":                 24,
	}
)
...
var file_pkg_api_api_proto_rawDesc = []byte{
	...
	0x3a, 0x02, 0x38, 0x01, 0x2a, 0xd3, 0x05, 0x0a, 0x0a, 0x43, 0x61, 0x70, 0x61, 0x62, 0x69, 0x6c,
	...
	,
	...
	,
	...
	0x50, 0x5f, 0x4d, 0x41, 0x58, 0x10, 0x06, 0x2a, 0xa3, 0x05, 0x0a, 0x05, 0x46, 0x69, 0x65, 0x6c,
	...
	0x65, 0x4d, 0x6f, 0x6e, 0x69, 0x74, 0x6f, 0x72, 0x69, 0x6e, 0x67, 0x10, 0x27, 0x32, 0xd8, 0x01,
