...
type IOPRIO_CLASS int32

const (
	IOPRIO_CLASS_NONE IOPRIO_CLASS = 0
	IOPRIO_CLASS_RT   IOPRIO_CLASS = 1
	IOPRIO_CLASS_BE   IOPRIO_CLASS = 2
	IOPRIO_CLASS_IDLE IOPRIO_CLASS = 3
)

// Enum value maps for IOPRIO_CLASS.
var (
	IOPRIO_CLASS_name = map[int32]string{
		0: "NONE",
		1: "RT",
		2: "BE",
		3: "IDLE",
	}
	IOPRIO_CLASS_value = map[string]int32{
		"NONE": 0,
		"RT":   1,
		"BE":   2,
		"IDLE": 3,
...
func (x IOPRIO_CLASS) Enum() *IOPRIO_CLASS {
	p := new(IOPRIO_CLASS)
	*p = x
	return p
}

func (x IOPRIO_CLASS) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (IOPRIO_CLASS) Descriptor() protoreflect.EnumDescriptor {
	return file_pkg_api_api_proto_enumTypes[2].Descriptor()
}

func (IOPRIO_CLASS) Type() protoreflect.EnumType {
	return &file_pkg_api_api_proto_enumTypes[2]
}

func (x IOPRIO_CLASS) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use IOPRIO_CLASS.Descriptor instead.
func (IOPRIO_CLASS) EnumDescriptor() ([]byte, []int) {
...
type LinuxIOPriority struct {
	...
	Class IOPRIO_CLASS `protobuf:"varint,1,opt,name=class,proto3,enum=nri.pkg.api.v1alpha1.IOPRIO_CLASS" json:"class,omitempty"`
...
func (x *LinuxIOPriority) GetClass() IOPRIO_CLASS {
	if x != nil {
		return x.Class
	}
...
var file_pkg_api_api_proto_rawDesc = []byte{
	...
	0x28, 0x03, 0x52, 0x05, 0x6c, 0x69, 0x6d, 0x69, 0x74, 0x22, 0x67, 0x0a, 0x0f, 0x4c, 0x69, 0x6e,
	0x75, 0x78, 0x49, 0x4f, 0x50, 0x72, 0x69, 0x6f, 0x72, 0x69, 0x74, 0x79, 0x12, 0x38, 0x0a, 0x05,
	0x63, 0x6c, 0x61, 0x73, 0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x22, 0x2e, 0x6e, 0x72,
	0x69, 0x2e, 0x70, 0x6b, 0x67, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x76, 0x31, 0x61, 0x6c, 0x70, 0x68,
	0x61, 0x31, 0x2e, 0x49, 0x4f, 0x50, 0x52, 0x49, 0x4f, 0x5f, 0x43, 0x4c, 0x41, 0x53, 0x53, 0x52,
	...
	0x74, 0x79, 0x22, 0xa6, 0x04, 0x0a, 0x13, 0x43, 0x6f, 0x6e, 0x74, 0x61, 0x69, 0x6e, 0x65, 0x72,
	...
	0x0a, 0x69, 0x6f, 0x50, 0x72, 0x69, 0x6f, 0x72, 0x69, 0x74, 0x79, 0x22, 0x9d, 0x01, 0x0a, 0x0f,
	...
	0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x2a, 0xd1, 0x02, 0x0a, 0x05, 0x45, 0x76, 0x65, 0x6e, 0x74,
	...
	0x32, 0x0a, 0x0c, 0x49, 0x4f, 0x50, 0x52, 0x49, 0x4f, 0x5f, 0x43, 0x4c, 0x41, 0x53, 0x53, 0x12,
	0x08, 0x0a, 0x04, 0x4e, 0x4f, 0x4e, 0x45, 0x10, 0x00, 0x12, 0x06, 0x0a, 0x02, 0x52, 0x54, 0x10,
	0x01, 0x12, 0x06, 0x0a, 0x02, 0x42, 0x45, 0x10, 0x02, 0x12, 0x08, 0x0a, 0x04, 0x49, 0x44, 0x4c,
	0x45, 0x10, 0x03, 0x32, 0xd8, 0x01, 0x0a, 0x07, 0x52, 0x75, 0x6e, 0x74, 0x69, 0x6d, 0x65, 0x12,
	...
	0x61, 0x69, 0x6e, 0x65, 0x72, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x32, 0xa1,
	0x06, 0x0a, 0x06, 0x50, 0x6c, 0x75, 0x67, 0x69, 0x6e, 0x12, 0x5c, 0x0a, 0x09, 0x43, 0x6f, 0x6e,
	...
	0x74, 0x79, 0x32, 0x57, 0x0a, 0x0d, 0x48, 0x6f, 0x73, 0x74, 0x46, 0x75, 0x6e, 0x63, 0x74, 0x69,
...
var file_pkg_api_api_proto_goTypes = []interface{}{
	...
	(IOPRIO_CLASS)(0),                // 2: nri.pkg.api.v1alpha1.IOPRIO_CLASS
...
var file_pkg_api_api_proto_depIdxs = []int32{
	...
	2,   // 78: nri.pkg.api.v1alpha1.LinuxIOPriority.class:type_name -> nri.pkg.api.v1alpha1.IOPRIO_CLASS
