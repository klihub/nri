...
func LinuxPodSandboxToV1alpha1(v1b1 *v1beta1.LinuxPodSandbox) *v1alpha1.LinuxPodSandbox {
	...
	v1a1 := &v1alpha1.LinuxPodSandbox{
		...
		Namespaces:   LinuxNamespacesToV1alpha1(v1b1.Namespaces),
...
func LinuxPodSandboxToV1beta1(v1a1 *v1alpha1.LinuxPodSandbox) *v1beta1.LinuxPodSandbox {
	...
	v1b1 := &v1beta1.LinuxPodSandbox{
		...
		Namespaces:   LinuxNamespacesToV1beta1(v1a1.Namespaces),
...
func ContainerToV1alpha1(v1b1 *v1beta1.Container) *v1alpha1.Container {
	...
	v1a1 := &v1alpha1.Container{
		...
		Args:          v1b1.Args,
		Env:           v1b1.Env,
		Mounts:        MountsToV1alpha1(v1b1.Mounts),
		Hooks:         HooksToV1alpha1(v1b1.Hooks),
		Linux:         LinuxContainerToV1alpha1(v1b1.Linux),
		Pid:           v1b1.Pid,
		Rlimits:       POSIXRlimitsToV1alpha1(v1b1.Rlimits),
		...
		CDIDevices:    CDIDevicesToV1alpha1(v1b1.CDIDevices),
	}
...
func ContainerToV1beta1(v1a1 *v1alpha1.Container) *v1beta1.Container {
	...
	v1b1 := &v1beta1.Container{
		...
		Args:          v1a1.Args,
		Env:           v1a1.Env,
		Mounts:        MountsToV1beta1(v1a1.Mounts),
		Hooks:         HooksToV1beta1(v1a1.Hooks),
		Linux:         LinuxContainerToV1beta1(v1a1.Linux),
		Pid:           v1a1.Pid,
		Rlimits:       POSIXRlimitsToV1beta1(v1a1.Rlimits),
		...
		CDIDevices:    CDIDevicesToV1beta1(v1a1.CDIDevices),
	}

	return v1b1
}

// MountsToV1alpha1 converts the request between v1alpha1 and v1beta1.
func MountsToV1alpha1(v1b1 []*v1beta1.Mount) []*v1alpha1.Mount {
	if v1b1 == nil {
		return nil
	}
...
// MountsToV1beta1 converts the request between v1alpha1 and v1beta1.
func MountsToV1beta1(v1a1 []*v1alpha1.Mount) []*v1beta1.Mount {
	if v1a1 == nil {
		return nil
	}
...
func LinuxContainerToV1alpha1(v1b1 *v1beta1.LinuxContainer) *v1alpha1.LinuxContainer {
	...
	v1a1 := &v1alpha1.LinuxContainer{
		Namespaces:     LinuxNamespacesToV1alpha1(v1b1.Namespaces),
		Devices:        LinuxDevicesToV1alpha1(v1b1.Devices),
		Resources:      LinuxResourcesToV1alpha1(v1b1.Resources),
...
func LinuxContainerToV1beta1(v1a1 *v1alpha1.LinuxContainer) *v1beta1.LinuxContainer {
	...
	v1b1 := &v1beta1.LinuxContainer{
		Namespaces:     LinuxNamespacesToV1beta1(v1a1.Namespaces),
		Devices:        LinuxDevicesToV1beta1(v1a1.Devices),
		Resources:      LinuxResourcesToV1beta1(v1a1.Resources),
...
func LinuxResourcesToV1alpha1(v1b1 *v1beta1.LinuxResources) *v1alpha1.LinuxResources {
	...
	v1a1 := &v1alpha1.LinuxResources{
		...
		HugepageLimits: HugepageLimitsToV1alpha1(v1b1.HugepageLimits),
		...
		Devices:        LinuxDeviceCgroupsToV1alpha1(v1b1.Devices),
...
// LinuxNamespacesToV1alpha1 converts the request between v1alpha1 and v1beta1.
func LinuxNamespacesToV1alpha1(v1b1 []*v1beta1.LinuxNamespace) []*v1alpha1.LinuxNamespace {
	if v1b1 == nil {
		return nil
	}
...
// LinuxNamespacesToV1beta1 converts the request between v1alpha1 and v1beta1.
func LinuxNamespacesToV1beta1(v1a1 []*v1alpha1.LinuxNamespace) []*v1beta1.LinuxNamespace {
	if v1a1 == nil {
		return nil
	}
...
// LinuxDevicesToV1alpha1 converts the request between v1alpha1 and v1beta1.
func LinuxDevicesToV1alpha1(v1b1 []*v1beta1.LinuxDevice) []*v1alpha1.LinuxDevice {
	if v1b1 == nil {
		return nil
	}
...
// LinuxDevicesToV1beta1 converts the request between v1alpha1 and v1beta1.
func LinuxDevicesToV1beta1(v1a1 []*v1alpha1.LinuxDevice) []*v1beta1.LinuxDevice {
	if v1a1 == nil {
		return nil
	}
...
// HugepageLimitsToV1alpha1 converts the request between v1alpha1 and v1beta1.
func HugepageLimitsToV1alpha1(v1b1 []*v1beta1.HugepageLimit) []*v1alpha1.HugepageLimit {
	if v1b1 == nil {
		return nil
	}
...
// HugepageLimitsToV1beta1 converts the request between v1alpha1 and v1beta1.
func HugepageLimitsToV1beta1(v1a1 []*v1alpha1.HugepageLimit) []*v1beta1.HugepageLimit {
	if v1a1 == nil {
		return nil
	}
...
// LinuxDeviceCgroupsToV1alpha1 converts the request between v1alpha1 and v1beta1.
func LinuxDeviceCgroupsToV1alpha1(v1b1 []*v1beta1.LinuxDeviceCgroup) []*v1alpha1.LinuxDeviceCgroup {
	if v1b1 == nil {
		return nil
	}
...
// LinuxDeviceCgroupsToV1beta1 converts the request between v1alpha1 and v1beta1.
func LinuxDeviceCgroupsToV1beta1(v1a1 []*v1alpha1.LinuxDeviceCgroup) []*v1beta1.LinuxDeviceCgroup {
	if v1a1 == nil {
		return nil
	}
...
func LinuxSeccompToV1alpha1(v1b1 *v1beta1.LinuxSeccomp) *v1alpha1.LinuxSeccomp {
	...
	v1a1 := &v1alpha1.LinuxSeccomp{
		...
		Syscalls:         LinuxSyscallsToV1alpha1(v1b1.Syscalls),
	}
...
func LinuxSeccompToV1beta1(v1a1 *v1alpha1.LinuxSeccomp) *v1beta1.LinuxSeccomp {
	...
	v1b1 := &v1beta1.LinuxSeccomp{
		...
		Syscalls:         LinuxSyscallsToV1beta1(v1a1.Syscalls),
	}

	return v1b1
}

// LinuxSyscallsToV1alpha1 converts the request between v1alpha1 and v1beta1.
func LinuxSyscallsToV1alpha1(v1b1 []*v1beta1.LinuxSyscall) []*v1alpha1.LinuxSyscall {
	if v1b1 == nil {
		return nil
	}
	...
	for _, s := range v1b1 {
		v1a1 = append(v1a1, &v1alpha1.LinuxSyscall{
			...
			Args:     LinuxSeccompArgsToV1alpha1(s.Args),
		})
	}
...
// LinuxSyscallsToV1beta1 converts the request between v1alpha1 and v1beta1.
func LinuxSyscallsToV1beta1(v1a1 []*v1alpha1.LinuxSyscall) []*v1beta1.LinuxSyscall {
	if v1a1 == nil {
		return nil
	}
	...
	for _, s := range v1a1 {
		v1b1 = append(v1b1, &v1beta1.LinuxSyscall{
			...
			Args:     LinuxSeccompArgsToV1beta1(s.Args),
		})
	}
...
// LinuxSeccompArgsToV1alpha1 converts the request between v1alpha1 and v1beta1.
func LinuxSeccompArgsToV1alpha1(v1b1 []*v1beta1.LinuxSeccompArg) []*v1alpha1.LinuxSeccompArg {
	if v1b1 == nil {
		return nil
	}
...
// LinuxSeccompArgsToV1beta1 converts the request between v1alpha1 and v1beta1.
func LinuxSeccompArgsToV1beta1(v1a1 []*v1alpha1.LinuxSeccompArg) []*v1beta1.LinuxSeccompArg {
	if v1a1 == nil {
		return nil
	}
...
// POSIXRlimitsToV1alpha1 converts the request between v1alpha1 and v1beta1.
func POSIXRlimitsToV1alpha1(v1b1 []*v1beta1.POSIXRlimit) []*v1alpha1.POSIXRlimit {
	if v1b1 == nil {
		return nil
	}
...
// POSIXRlimitsToV1beta1 converts the request between v1alpha1 and v1beta1.
func POSIXRlimitsToV1beta1(v1a1 []*v1alpha1.POSIXRlimit) []*v1beta1.POSIXRlimit {
	if v1a1 == nil {
		return nil
	}
...
// CDIDevicesToV1alpha1 converts the request between v1alpha1 and v1beta1.
func CDIDevicesToV1alpha1(v1b1 []*v1beta1.CDIDevice) []*v1alpha1.CDIDevice {
	if v1b1 == nil {
		return nil
	}
...
// CDIDevicesToV1beta1 converts the request between v1alpha1 and v1beta1.
func CDIDevicesToV1beta1(v1a1 []*v1alpha1.CDIDevice) []*v1beta1.CDIDevice {
	if v1a1 == nil {
		return nil
	}
...
func ContainerAdjustmentToV1alpha1(v1b1 *v1beta1.ContainerAdjustment) *v1alpha1.ContainerAdjustment {
	...
	v1a1 := &v1alpha1.ContainerAdjustment{
		Annotations: v1b1.Annotations,
		Mounts:      MountsToV1alpha1(v1b1.Mounts),
		Env:         KeyValuesToV1alpha1(v1b1.Env),
		Hooks:       HooksToV1alpha1(v1b1.Hooks),
...
func ContainerAdjustmentToV1beta1(v1a1 *v1alpha1.ContainerAdjustment) *v1beta1.ContainerAdjustment {
	...
	v1b1 := &v1beta1.ContainerAdjustment{
		Annotations: v1a1.Annotations,
		Mounts:      MountsToV1beta1(v1a1.Mounts),
		Env:         KeyValuesToV1beta1(v1a1.Env),
		Hooks:       HooksToV1beta1(v1a1.Hooks),
...
// ContainerUpdatesToV1alpha1 converts the request between v1alpha1 and v1beta1.
func ContainerUpdatesToV1alpha1(v1b1 []*v1beta1.ContainerUpdate) []*v1alpha1.ContainerUpdate {
	if v1b1 == nil {
		return nil
	}
...
// ContainerUpdatesToV1beta1 converts the request between v1alpha1 and v1beta1.
func ContainerUpdatesToV1beta1(v1a1 []*v1alpha1.ContainerUpdate) []*v1beta1.ContainerUpdate {
	if v1a1 == nil {
		return nil
	}
...
// KeyValuesToV1alpha1 converts the request between v1alpha1 and v1beta1.
func KeyValuesToV1alpha1(v1b1 []*v1beta1.KeyValue) []*v1alpha1.KeyValue {
	if v1b1 == nil {
		return nil
	}
...
// KeyValuesToV1beta1 converts the request between v1alpha1 and v1beta1.
func KeyValuesToV1beta1(v1a1 []*v1alpha1.KeyValue) []*v1beta1.KeyValue {
	if v1a1 == nil {
		return nil
	}
...
// ContainerEvictionsToV1alpha1 converts the request between v1alpha1 and v1beta1.
func ContainerEvictionsToV1alpha1(v1b1 []*v1beta1.ContainerEviction) []*v1alpha1.ContainerEviction {
	if v1b1 == nil {
		return nil
	}
...
// ContainerEvictionsToV1beta1 converts the request between v1alpha1 and v1beta1.
func ContainerEvictionsToV1beta1(v1a1 []*v1alpha1.ContainerEviction) []*v1beta1.ContainerEviction {
	if v1a1 == nil {
		return nil
	}
...
// PluginInstancesToV1alpha1 converts the request between v1alpha1 and v1beta1.
func PluginInstancesToV1alpha1(v1b1 []*v1beta1.PluginInstance) []*v1alpha1.PluginInstance {
	if v1b1 == nil {
		return nil
	}
