					...
					options: []nri.Option{
						nri.WithDefaultValidator(
							&validator.DefaultValidatorConfig{
								...
								TolerateMissingAnnotation: "tolerate-missing-plugins." + api.AnnotationDomain,
							},
						),
					},
				},
		...
		It("should allow container creation, if missing plugins are tolerated", func() {
			var (
				...
				pod = &api.PodSandbox{
					...
					Namespace: "default",
					Annotations: map[string]string{
						"tolerate-missing-plugins." + api.AnnotationDomain + "/container.ctr0": "true",
					},
				}
			)
		...
		It("should not allow container creation if annotated required plugins are missing", func() {
			var (
				...
				pod = &api.PodSandbox{
					...
					Namespace: "default",
					Annotations: map[string]string{
						"required-plugins." + api.AnnotationDomain + "/container.ctr0": "[ \"xyzzy\" ]",
					},
				}
			)
