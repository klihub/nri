...
// WithAuthentication sets authentiction keys for the plugin. The plugin will
...
func (stub *stub) authenticate(ctx context.Context) error {
	...
	log.Infof(ctx, "Authenticated with identity %q (tags: %v)...", result.Identity, result.Tags)
