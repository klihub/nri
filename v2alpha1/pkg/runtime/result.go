...
func (ro resultOwners) clearMemLimit(id string) {
	ro.ownersFor(id).clearMemLimit()
}

func (ro resultOwners) clearMemReservevation(id string) {
	ro.ownersFor(id).clearMemReservation()
}

func (ro resultOwners) clearMemSwapLimit(id string) {
	ro.ownersFor(id).clearMemSwapLimit()
}

func (ro resultOwners) clearMemKernelLimit(id string) {
	ro.ownersFor(id).clearMemKernelLimit()
}

func (ro resultOwners) clearMemTCPLimit(id string) {
	ro.ownersFor(id).clearMemTCPLimit()
}

func (ro resultOwners) clearMemSwappiness(id string) {
	ro.ownersFor(id).clearMemSwappiness()
}

func (ro resultOwners) clearMemDisableOomKiller(id string) {
	ro.ownersFor(id).clearMemDisableOomKiller()
}

func (ro resultOwners) clearMemUseHierarchy(id string) {
	ro.ownersFor(id).clearMemUseHierarchy()
}

func (ro resultOwners) clearCpuShares(id string) {
	ro.ownersFor(id).clearCpuShares()
}

func (ro resultOwners) clearCpuQuota(id string) {
	ro.ownersFor(id).clearCpuQuota()
}

func (ro resultOwners) clearCpuPeriod(id string) {
	ro.ownersFor(id).clearCpuPeriod()
}

func (ro resultOwners) clearCpuRealtimeRuntime(id string) {
	ro.ownersFor(id).clearCpuRealtimeRuntime()
}

func (ro resultOwners) clearCpuRealtimePeriod(id string) {
	ro.ownersFor(id).clearCpuRealtimePeriod()
}

func (ro resultOwners) clearCpusetCpus(id string) {
	ro.ownersFor(id).clearCpusetCpus()
}

func (ro resultOwners) clearCpusetMems(id string) {
	ro.ownersFor(id).clearCpusetMems()
}

func (ro resultOwners) clearHugepageLimits(id, size string) {
	ro.ownersFor(id).clearHugepageLimits(size)
}

func (ro resultOwners) clearBlockioClass(id string) {
	ro.ownersFor(id).clearBlockioClass()
}

func (ro resultOwners) clearRdtClass(id string) {
	ro.ownersFor(id).clearRdtClass()
}

func (ro resultOwners) clearCgroupsPath(id string) {
	ro.ownersFor(id).clearCgroupsPath()
}
...
func (o *owners) clearMemLimit() {
	o.memLimit = ""
}

func (o *owners) clearMemReservation() {
	o.memReservation = ""
}

func (o *owners) clearMemSwapLimit() {
	o.memSwapLimit = ""
}

func (o *owners) clearMemKernelLimit() {
	o.memKernelLimit = ""
}

func (o *owners) clearMemTCPLimit() {
	o.memTCPLimit = ""
}

func (o *owners) clearMemSwappiness() {
	o.memSwappiness = ""
}

func (o *owners) clearMemDisableOomKiller() {
	o.memDisableOomKiller = ""
}

func (o *owners) clearMemUseHierarchy() {
	o.memUseHierarchy = ""
}

func (o *owners) clearCpuShares() {
	o.cpuShares = ""
}

func (o *owners) clearCpuQuota() {
	o.cpuQuota = ""
}

func (o *owners) clearCpuPeriod() {
	o.cpuPeriod = ""
}

func (o *owners) clearCpuRealtimeRuntime() {
	o.cpuRealtimeRuntime = ""
}

func (o *owners) clearCpuRealtimePeriod() {
	o.cpuRealtimePeriod = ""
}

func (o *owners) clearCpusetCpus() {
	o.cpusetCpus = ""
}

func (o *owners) clearCpusetMems() {
	o.cpusetMems = ""
}

func (o *owners) clearHugepageLimits(size string) {
	if o.hugepageLimits == nil {
		return
	}
	delete(o.hugepageLimits, size)
}

func (o *owners) clearBlockioClass() {
	o.blockioClass = ""
}

func (o *owners) clearRdtClass() {
	o.rdtClass = ""
}

func (o *owners) clearCgroupsPath() {
	o.cgroupsPath = ""
}
